...
import { BrainCircuit, Send, Trash } from 'lucide-react';
...
`;
  ...
  const clearChat = () => { // {{ edit_2 }}
    setConversation([initialMessage]);
    localStorage.setItem('conversation', JSON.stringify([initialMessage]));
  };
  ...
  return (
    <div className="bg-black/60 rounded-xl backdrop-blur-md border border-red-500/20 p-6 w-full max-w-2xl mx-auto">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="text-xl font-bold text-red-400">AI Chat Interface</h3>
        <button onClick={clearChat} className="ml-auto"> {/* {{ edit_3 }} */}
